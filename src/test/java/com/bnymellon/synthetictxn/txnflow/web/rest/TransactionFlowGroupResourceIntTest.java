...
import com.bnymellon.synthetictxn.txnflow.repository.TransactionFlowGroupRepository;
...
public class TransactionFlowGroupResourceIntTest {
    ...
    public void setup() {
        ...
        final TransactionFlowGroupResource transactionFlowGroupResource = new TransactionFlowGroupResource(transactionFlowGroupRepository);
    ...
    public void updateTransactionFlowGroup() throws Exception {
        ...
        TransactionFlowGroup updatedTransactionFlowGroup = transactionFlowGroupRepository.findById(transactionFlowGroup.getId()).get();
        // Disconnect from session so that the updates on updatedTransactionFlowGroup are not directly saved in db
        em.detach(updatedTransactionFlowGroup);
    ...
    public void equalsVerifier() throws Exception {
        ...
        TransactionFlowGroup transactionFlowGroup1 = new TransactionFlowGroup();
        transactionFlowGroup1.setId(1L);
        TransactionFlowGroup transactionFlowGroup2 = new TransactionFlowGroup();
        transactionFlowGroup2.setId(transactionFlowGroup1.getId());
        assertThat(transactionFlowGroup1).isEqualTo(transactionFlowGroup2);
        transactionFlowGroup2.setId(2L);
        assertThat(transactionFlowGroup1).isNotEqualTo(transactionFlowGroup2);
        transactionFlowGroup1.setId(null);
        assertThat(transactionFlowGroup1).isNotEqualTo(transactionFlowGroup2);
    }
}
