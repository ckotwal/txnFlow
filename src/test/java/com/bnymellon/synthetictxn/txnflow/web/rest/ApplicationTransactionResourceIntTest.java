...
import com.bnymellon.synthetictxn.txnflow.domain.enumeration.EventRepositoryType;
/**
...
public class ApplicationTransactionResourceIntTest {
    ...
    public void setup() {
        ...
        final ApplicationTransactionResource applicationTransactionResource = new ApplicationTransactionResource(applicationTransactionRepository);
    ...
    public void updateApplicationTransaction() throws Exception {
        ...
        ApplicationTransaction updatedApplicationTransaction = applicationTransactionRepository.findById(applicationTransaction.getId()).get();
        // Disconnect from session so that the updates on updatedApplicationTransaction are not directly saved in db
        em.detach(updatedApplicationTransaction);
    ...
    public void equalsVerifier() throws Exception {
        ...
        ApplicationTransaction applicationTransaction1 = new ApplicationTransaction();
        applicationTransaction1.setId(1L);
        ApplicationTransaction applicationTransaction2 = new ApplicationTransaction();
        applicationTransaction2.setId(applicationTransaction1.getId());
        assertThat(applicationTransaction1).isEqualTo(applicationTransaction2);
        applicationTransaction2.setId(2L);
        assertThat(applicationTransaction1).isNotEqualTo(applicationTransaction2);
        applicationTransaction1.setId(null);
        assertThat(applicationTransaction1).isNotEqualTo(applicationTransaction2);
    }
}
