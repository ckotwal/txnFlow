...
public class ApplicationTransaction implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (applicationTransaction.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), applicationTransaction.getId());
    }
    ...
    public String toString() {
        return "ApplicationTransaction{" +
            ...
            ", eventRepositoryType='" + getEventRepositoryType() + "'" +
            ", repositoryEventName='" + getRepositoryEventName() + "'" +
            "}";
    }
}
