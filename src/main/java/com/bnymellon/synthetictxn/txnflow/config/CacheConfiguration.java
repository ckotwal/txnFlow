...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("TransactionFlowConfiguration");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("TransactionFlowConfiguration");
        ...
        config.getMapConfigs().put("com.bnymellon.synthetictxn.txnflow.domain.*", initializeDomainMapConfig(jHipsterProperties));
